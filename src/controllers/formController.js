...
const handleUserResponse = async (chatId, message, client) => {
    ...
    switch (userData.step) {
        ...
        case 3:
            ...
            await saveUserResponse(chatId, { experience: message, step: 4 });
        ...
        case 4:
            ...
            await saveUserResponse(chatId, { strengths: message, step: 5 });
        ...
        case 5:
            ...
            await saveUserResponse(chatId, { team_role: message, step: 6 });
        ...
        case 6:
            ...
            await saveUserResponse(chatId, { ai_tools: message, step: 7 });
        ...
        case 7:
            ...
            await saveUserResponse(chatId, { ai_interest: message, step: 8 });
        ...
        case 8:
            ...
            await saveUserResponse(chatId, { problem_solving: message, step: 9 });
        ...
        case 9:
            ...
            await saveUserResponse(chatId, { ai_learning_interest: message, step: 10 });
        ...
        case 10:
            ...
            await saveUserResponse(chatId, { ai_solution: message, step: 11 });
        ...
        case 11:
            ...
            await saveUserResponse(chatId, { event_expectations: message, step: 12 });
            ...
            case 12:
                ...
                await client.sendMessage(chatId, 
                    ...
                    "📌 *¿Pudiste llenar tu cuestionario?*\n\n" +
